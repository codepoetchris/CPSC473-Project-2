//This code was taken from https://jsfiddle.net/scottux/HtZu6/.  Our intent is
//to divy up this logic into the ember framework
...
$(window).load(function() {
  ...
  (function() {
    ...
    var declareWinner = function(userHand, dealerHand) {
      ...
      while (dealerHand.score() < 17 && dealerHand.score() < userScore) {
        dealerHand.hitMe();
        updateUI();
      }
      ...
      return '<h2>' + outcome + '</h2>' + '<br />Dealer: ' + dealerHand.score() + '<br />You: ' + userScore;
    };

    /** Holds your Hand */
    var yourHand, dealersHand;
    ...
    var updateUI = function() {
      /* Cards */
      //Dealer's Hand
      $dealerHand.html(dealersHand.toHtml());
      //User's Hand
    ...
    $standButton.on('click', function() {
      $yourHand.html(declareWinner(yourHand, dealersHand));
      showDeal();
    });
